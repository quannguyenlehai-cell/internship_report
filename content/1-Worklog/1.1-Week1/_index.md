...
| 5   | - Finalize Hardware Choices: Select the specific microcontrollers (ESP32-CAM + ESP32) and servo (SG90) <br> - Draft a theoretical circuit schematic detailing the power distribution (external 5V) and common ground                           | 06/04/2026 | 06/04/2026      |  |
